...
export default function CommissionModal({ disclosure }: { disclosure: UseCustomDisclosureReturn }) {
  const { detailCommission } = useModal();

  const handleOpenDetailCommissionModal = () => {
    detailCommission.state.onOpen
  }
  return (
    <>
      <Modal
      ...
      >
        <ModalContent>
          <ModalHeader>คอมมิชชั่น</ModalHeader>
          <ModalBody>
